#!/clusterfs/jgi/groups/science/homes/jvillada/my_software/moducomp/.pixi/envs/default/bin/python
...
BASE_URL = f'https://eggnog5.embl.de/download/emapperdb-{__DB_VERSION__}'
